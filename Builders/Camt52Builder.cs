...
using Exthand.FinanceExports.Models.Camt52;
...
{
    public class Camt52Builder : BaseBuilder
    {
        public Document52 Camt52Document { get; private set; }
        ...
        public override Stream GetResultAsStream()
        {
            ...
            var serializer = new XmlSerializer(typeof(Document52));
            serializer.Serialize(memoryStream, Camt52Document);
            return memoryStream;
        }
        ...
        public override string GetResultAsString()
        {
            ...
            {
                var serializer = new XmlSerializer(typeof(Document52));
                serializer.Serialize(stringwriter, Camt52Document);
