...
{
    /// <summary>
    /// Coda Line Type 3.2. "Information Record"
    /// 32AAAABBBBCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC          D E
    /// 
    /// Examples:
    /// 32000200016 RUE DE HASSELT                                                                                                   0 0
    /// 
    /// A -   4  N - Continuous sequence number
    /// B -   4  N - Detail number
    /// C - 105 AN - Communication
    /// D -   1  N - Next code: 
    ...
    /// </summary>
    public class CodaLineType32 : ICodaLineType
    {
        ...
        /// Get Coda Line Type
        /// </summary>
        public CodaLineType GetCodaLineType() => CodaLineType.InformationPart2;
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append(CodaStringHelper.TrucateOrPadRight(Communication, 105));
